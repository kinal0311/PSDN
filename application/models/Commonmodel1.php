...
class Commonmodel extends CI_Model {
         ...
         public function send_sms($phone,$otpMsg)
        {
        	 ...
        	 $msgContent="http://api.msg91.com/api/sendhttp.php?route=4&sender=TESTIN&mobiles=".$phone."&authkey=273355AY7MXrX08qN5cbc5435&encrypt=&message=".urlencode($otpMsg)."&unicode=1&country=91";
