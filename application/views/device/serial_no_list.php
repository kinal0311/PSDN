                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <!--</h2>   -->
                             <h2>
                               Automated Stock - without SIM Numbers
                            </h2>   
					...
					<!--- Search---->
								<form action="<?php echo base_url() ?>device/serial_numbers" name="searchfilter"  id="searchfilter" method="get" />				
			...
			<!---- Search ---->
              ...
              <table id="mytable" class="table table-bordred table-striped" style="width: 100% !important;">
				...
				{						
						...
						<tr>
							<td><?php echo $sno; ?> </td>
							<td><?php echo $value['s_created_date']; ?></td>
