...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Distributor Login</a>
                ...
                <form id="sign_in" method="POST" novalidate="novalidate">
                    ...
                    <div class="row m-t-15 m-b--20">
                        ...
                        <div class="col-xs-12 align-right">
                            <a href="<?php echo base_url() ?>dealer/forgot_password">Forgot Password?</a>
                        </div>
                    </div>
                </form>
            </div>
	...
	<script src="<?php echo base_url() ?>public/js/pages/function/distributor_sign_in.js?t=<?php echo time(); ?>"></script>
