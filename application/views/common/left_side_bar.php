...
function writeMsg($user_type)
{
    ...
    if ((string) $user_type === '0') {
        ...
        $display_user_type = 'Sub Admin';

    } else if ((string) $user_type === '5') {
        $display_user_type = 'Device Team';
    }
...
<?php if (check_permission($user_type, 'menu_stocks')) { ?>
    <?php if ($this->session->userdata("user_id") != '9') { ?>
            ...
            <ul class="ml-menu">
                ...
                <?php if (check_permission($user_type, 'admin_access')) {?>
                    <!--<li>-->
                    <!--    <a href="<?php echo base_url(); ?>device/scan">-->
                    <!--       Scan-->
                    <!--    </a>-->
                    <!--</li>-->
                    <!-- <li>
                    ...
                    <li>
                        <a href="<?php echo base_url() ?>admin/scan">Scan</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url() ?>admin/scan_bulk_upload">Stock Bulk Import</a>
                    </li>
                <?php }else if(check_permission($user_type,'scan_bulk_upload')){?>
                      <li>
                        <a href="<?php echo base_url() ?>admin/scan_bulk_upload">Stock Bulk Import</a>
                    </li>
                <?php } ?>
...
<li><a href="<?php echo base_url() ?>admin/faulty_device">Faulty Devices</a></li>
...
<?php if (check_permission($user_type, 'menu_cerificate_create')) {?>
                             <li>
                                <a href="<?php echo base_url() ?>admin/expiring_list">Expiring Subscription</a>
                            </li>
<?php }?>
<?php if (check_permission($user_type, 'menu_cerificate_create')) {?>
                             <li>
                                <a href="<?php echo base_url() ?>admin/expired_list">Expired Subscription</a>
                            </li>
<?php }?>
                        </ul>
                    </li>
    ...
    <?php if ($usertype == 0) {?>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>admin/invoices_list_customers">
                            <i class="material-icons">receipt</i>
                            <?php if ($usertype == 0 ) {?>
                                <span>Distributor Invoices</span>
                            <?php }?>
                        </a>
                    </li>
<?php }?>
...
<?php if (check_permission($user_type, 'menu_customer')) {?>
    <li>
        <a href="javascript:void(0);" class="menu-toggle <?php echo ($currentActivePage === 'Create_Customer' || $currentActivePage === 'Customer_List') ? 'toggled' : ""; ?>">
        <i class="material-icons">supervisor_account</i> <span>Customers</span>
        </a>
        <ul class="ml-menu">
            <?php if ($this->session->userdata("user_id") != '9') {?>
                <li><a href="<?php echo base_url() ?>admin/create_customer">Create Customer</a></li>
                    <li>
                        <a href="<?php echo base_url(); ?>admin/customers_list">Customers List</a>
                    </li>
            <?php }?>
        </ul>
    </li>
...
<?php }?>
    ...
    <li>
        ...
        <ul class="ml-menu">
           <!--  <?php if (check_permission($user_type, 'menu_report_dealer_sales_report')) {?>
            ...
            <li>
                <a href="<?php echo base_url() ?>admin/daily_reports">Daily Run</a>
            </li>
            <?php }?>
        </ul>
    </li>
    <?php }?>
    <?php if (check_permission($user_type, 'menu_track_vehicle')) { ?>
                    <li>
                        <a href="<?php echo base_url(); ?>portal/all_customer_vehicles">
                         <i class="material-icons">directions_bus</i> 
                          <span>Track Vehicle</span>
                        </a>
                    </li>
    <?php } ?>
    <?php  if (check_permission($user_type, 'menu_distributor_track_vehicle')) {
         if ($this->session->userdata('user_type') == '2'){
        ?>
                    <li>
                        <a href="<?php  echo base_url(); ?>portal/distributor_customer">
                         <i class="material-icons">directions_bus</i> 
                          <span>Distributor Track Vehicle</span>
                        </a>
                    </li>
    <?php 
     } }
    ?>
    <?php if (check_permission($user_type, 'menu_dealer_track_vehicle')) {
        if ($this->session->userdata('user_type') == '1') {
        ?>
                    <li>
                        <a href="<?php echo base_url(); ?>portal/dealer_customer">
                         <i class="material-icons">directions_bus</i> 
                          <span>Dealer Track Vehicle</span>
                        </a>
                    </li>
    <?php 
     } }
    ?>
                ...
                <?php } else { ?>
                    ...
                    <!--    <a href="<?php echo base_url(); ?>device/scan">-->
                    <!--        <i class="material-icons">directions_bus</i>-->
                    <!--        <span>Manual Stock Entry - Scan</span>-->
                    <!--    </a>-->
                    <!--</li>-->
                    <li>
                        <a href="<?php echo base_url(); ?>device/serial_numbers">
                            <i class="material-icons">format_list_numbered</i>
                            <span>Automated Stock - without SIM</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>device/import">
                            <i class="material-icons">format_list_numbered</i>
                            <span>Upload SIM Numbers</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>device/stock_list">
                            <i class="material-icons">format_list_numbered</i>
                            <span>Final Stock List</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>device/print">
                            <i class="material-icons">format_list_numbered</i>
                            <span>Print Stickers</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>device/unregistered_data">
                            <i class="material-icons">format_list_numbered</i>
                            <span>Unregistered Device Data</span>
                        </a>
                    </li>
                    <li>
                    <a href="<?php echo base_url(); ?>device/registered_data">
                        <i class="material-icons">format_list_numbered</i>
                        <span>Registered Device Data</span>
                    </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>device/check_device_data/<?php echo date('Y-m-d') ?>/00:00/23:59/0">
                            <i class="material-icons">directions_bus</i>
                            <span>Device Data Check</span>
                        </a>
                    </li>
                ...
                <?php if ($this->session->userdata('user_type') == '0') { ?>
                   <li>
                       <a href="<?php echo base_url(); ?>admin/service_mail">
                           <i class="material-icons">account_box</i>
                           <span>Send Service Mail</span>
                       </a>
                   </li>
                <?php }?>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>admin/check_console">
                            <i class="material-icons">format_list_numbered</i>
                            <span>Console</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>device/logout">
            ...
            <div class="legal">
                <div class="copyright">
                    Copyright&copy; 2023 <a href="javascript:void(0);">PSDN</a>.
                </div>
                <div class="version">
