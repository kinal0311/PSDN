        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<!--- Search---->
								<form action="<?php echo base_url().$redirectionBase; ?>/view_inventoryreport" name="searchfilter"  id="form_validation"  method="get" novalidate />				
										<div class="row clearfix">
...
<?php
    ...
    height: 100%;    margin-top: -50px;"   src=""></iframe>
                        </div>
                    </div>
                </div>
            </div>
