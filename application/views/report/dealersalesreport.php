            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                           <div class="table-responsive" style="    overflow-x: hidden;    height: 60%;">
					<!--- Search---->
								<form action="<?php echo base_url().$redirectionBase; ?>/view_dealersalesreport" name="searchfilter"  id="form_validation"  method="get" novalidate />				
										<div class="row clearfix">
												...
												<div class="form-group">
													<div class="form-line">
														...
														onchange="return select_user_type(event,this);" 
														 id="user_type" data-live-search="true" data-size="5" required>
											...
											<div class="col-sm-4" style="<?php echo $dealerNone; ?>">
												<div class="form-group">
													<div class="form-line">
														<select class="form-control show-tick" name="user_id" id="user_id" data-live-search="true" data-size="5" required>
						...
						<!-- 					<div class="col-sm-4" >
										...
										<!-- 	<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
														<input type="text" class="form-control" placeholder="Search by serial no" id="serial_no" value="" name="serial_no">
													</div>
												</div>
											</div> -->
											<div class="col-sm-4">
