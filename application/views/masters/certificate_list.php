            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                               Certificate Allocation - Create Limit
                            </h2>        
<?php if(check_permission($user_type,'cerificate_allocation_create')){ ?>
                            ...
                            <!--            <li><a href="<?php echo base_url().'admin/create_certificate'; ?>">Create</a></li>                                        -->
                            <!--        </ul>-->
                            <!--    </li>-->
                            <!--</ul>    -->
 <?php } ?>                                         
					...
					<!--- Search---->
								<form action="<?php echo base_url() ?>admin/certificate_list" name="searchfilter"  id="searchfilter" method="get" />				
										<input type="hidden" name="offset"   id="offset" value="<?php echo isset($_GET['offset'])?$_GET['offset']:0; ?>">				
										<div class="row clearfix">
											<div class="col-sm-4">
												<div class="form-group">
													<div class="form-line">
													<?php /*	<input type="text" class="form-control" placeholder="Search by company name,tac number" id="search" value="<?php echo isset($_GET['search'])?$_GET['search']:""; ?>" name="search"> */ ?>
													</div>
												</div>
											</div>									
