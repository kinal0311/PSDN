...
<body class="<?php echo THEME_BODY_HEADER_COLOR; ?>">
  ...
  <?php $this->load->view('common/left_side_bar'); ?>
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" enctype="multipart/form-data">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" tabindex="1" autofocus id="v_vehicle_make" name="v_vehicle_make" required>
	...
	<!--- Model Dialog ---->
	 ...
	 <script src="<?php echo base_url() ?>public/js/pages/function/create_vehicle_make.js?t=<?php echo time(); ?>"></script>
