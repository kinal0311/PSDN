...
<body class="<?php echo THEME_BODY_HEADER_COLOR; ?>">
  ...
  <?php $this->load->view('common/left_side_bar'); ?>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                             ...
                             <div class="form-group form-float">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="veh_owner_name"  id="veh_owner_name" required autocomplete="off" readonly="readonly" onfocus="javascript:this.removeAttribute('readonly')">
                                        <label class="form-label">Owner Name</label>
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="email" class="form-control" name="veh_owner_email"  id="veh_owner_email" autocomplete="off" readonly="readonly" onfocus="javascript:this.removeAttribute('readonly')">
                              ...
                              <div class="form-group form-float">
                                ...
                                <div class="form-group form-float">
                                     <div class="form-line">
                                        <select class="form-control show-tick" name="veh_serial_no"  id="veh_serial_no" data-live-search="true">
							...
							<div class="form-group form-float">
                                    <div class="form-line">
										<select class="form-control show-tick" name="veh_rto_no"  id="veh_rto_no" data-live-search="true">
                            ...
                            <div class="row clearfix">
                                ...
                                <label class="form-label">Selling Price</label><br />
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" name="selling_price" step="1"  id="selling_price" placeholder="Selling Price" required value="5000">
                                        </div>
                                    </div>
                                </div>
								<div class="col-sm-4">
                                <label class="form-label">Validity To</label><br />
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="validity_to"  id="validity_to" placeholder="Please choose date.." value="<?php echo $validity_to; ?>" required readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
	...
	<!--- Model Dialog ---->
	 ...
	 <script src="<?php echo base_url() ?>public/js/pages/function/create_certificate_entry.js?t=<?php echo 2; ?>"></script>
