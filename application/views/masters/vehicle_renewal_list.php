                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <!--            <li><a href="<?php echo base_url().'admin/create_renewal_entry'; ?>">Create</a></li>                                        -->
                            <!--        </ul>-->
                            <!--    </li>-->
                            <!--</ul>                         -->
                        </div>
					...
					<!--- Search---->
								<form action="<?php echo base_url().$redirectionBase; ?>/renewal_list" name="searchfilter"  id="searchfilter" method="get" />				
			...
			<!---- Search ---->
              ...
              <table id="mytable" class="table table-bordred table-striped">
				...
				if(count($listofvehicles)>0)
				{
						...
						<tr>
						<td><?php echo $sno; ?></td>
						<td><?php echo $value['veh_serial_no']; ?></td>
						...
						<?php
							...
							$href=base_url()."admin/downloadRenewalwebpdf?id=".$pdfEncode;
							$user_type=$this->session->userdata('user_type');
						?>
						<td class="text-left">
							<?php
