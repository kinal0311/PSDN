...
<span for="s_user_type2ss" >: <?php echo $userType; ?></span>
                                ...
                                <div class="form-group" id="fitment_access_div">
                                    <?php
                                    $access=isset($userinfo['user_fitment_access'])?$userinfo['user_fitment_access']:0; 
                                    $Y=$N="";
                                    if($access)
                                    {
                                        $Y='checked="checked"';
                                    ...
                                    <input type="radio" name="fitment_access" <?php echo $Y; ?> id="fitment_access_yes" value="1" class="with-gap radio-col-deep-purple">
                                    <label for="fitment_access_yes">Yes</label>

                                    <input type="radio" name="fitment_access" id="fitment_access_no" value="0" class="with-gap radio-col-deep-purple" <?php echo $N; ?>>
                          ...
                          $option='<option value="'.$userinfo["dis_id"].'">'.$userinfo["dis_name"].'</option>';
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="email" class="form-control" value="<?php echo isset($userinfo['user_email'])?$userinfo['user_email']:""; ?>" name="email">
								...
								<div class="form-group form-float" style="display: <?php if($user_type == 4){ echo "block"; } else { echo "none"; } ?>">
                                    <div class="form-line">
										<select class="form-control show-tick" name="user_states" data-live-search="true" required>
											...
											{ 
												$selected='';
												if(isset($userinfo['state_id']) && (string)$userinfo['state_id']===(string)$value['id'])
												{
													$selected='selected="selected"';
												}
											?>
							...
							<div class="form-group form-float">
								<div class="form-line">
									...
									<?php if(isset($userinfo['user_photo']) &&  strlen($userinfo['user_photo'])>0) { ?>
										<div class="pull-left" style="color:#1F91F3"><p></p><a href="<?php echo base_url().$userinfo['user_photo']; ?>" target="_blank" download>Download</a></div>
									<?php } ?>
									<div class="help-info" style="color:#1F91F3" >Allowed image formats : <b>jpg,jpeg,gif,png,bmp</b> (Max 5 MB)</div>
								</div>		
                                <input type="hidden" id="photo_personal" name="photo_personal" value="<?php echo isset($userinfo['user_photo'])?$userinfo['user_photo']:""; ?>" />								
							</div>
							<br>
							<div class="form-group form-float">
								<div class="form-line">
                                ...
                                <input type="hidden" id="pan_card" name="pan_card" value="<?php echo isset($userinfo['user_photo'])?$userinfo['user_photo']:""; ?>" />								
							</div>
							<br>
							<div class="form-group form-float">
								<div class="form-line">
                                ...
                                <input type="hidden" id="cancelled_cheque_leaf" name="cancelled_cheque_leaf" value="<?php echo isset($userinfo['user_photo'])?$userinfo['user_photo']:""; ?>" />								
							</div>
							<br>
							<div class="form-group form-float">
							<div class="form-line">
