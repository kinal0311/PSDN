        ...
        <div class="container-fluid">
           ...
           <!--                     </div><br>-->
                              ...
                              <div class="form-group form-float">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="datetimepicker form-control" name="veh_register_date" value="<?php echo (isset($userinfo['veh_register_date']) && $userinfo['veh_register_date'] !="0000-00-00")?$userinfo['veh_register_date']:""; ?>" id="veh_register_date">
