            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                               Unassigned Serial Numbers List
                            </h2>    
					...
					<!--- Search---->
								<form action="<?php echo base_url() ?>admin/unassigned_serial_number_list" name="searchfilter"  id="searchfilter" method="get" />				
										...
										<div class="row clearfix">
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														<input type="text" class="form-control" placeholder="Search by serial number." id="search" value="<?php echo isset($_GET['search'])?$_GET['search']:""; ?>" name="search">
													</div>
												</div>
											</div>									
											<div class="col-sm-3">
										...
										$product_id = preg_replace("/&#?[a-z0-9]+;/i","",$_REQUEST["s_product_id"]);
													...
													?>
							<input type="hidden" id="hid_product_id" value="<?php echo $product_id; ?>">
...
<?php if(check_permission($user_type,'assign_to_distributer_edit')){ ?>
						<td class="text-left">
							 <a class='btn btn-info btn-xs' href="<?php echo base_url()."admin/edit_unassigned_serial_number/".$value['s_serial_id']; ?>">
