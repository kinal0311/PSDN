							...
							<div class="table-responsive">
								...
								<div class="form-group">
									<div class="" style="float:right;">
										<a href="<?php echo base_url() ?>public/customer_bulk_import.xlsx" class="btn btn-primary waves-effect">Download Sample File</a>
									</div>
								</div>
								<form action="<?= base_url('admin/import_customers') ?>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<div class="form-line">
