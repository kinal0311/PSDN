...
<body class="<?php echo THEME_BODY_HEADER_COLOR; ?>">
  ...
  <?php $this->load->view('common/left_side_bar'); ?>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" tabindex="1" autofocus id="rto_number" name="rto_number" required>
                                        <label class="form-label">RTO Number</label>
                                    </div>
                                </div>  
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" tabindex="2" autofocus id="rto_place" name="rto_place" required>
	...
	<!--- Model Dialog ---->
	 ...
	 <script src="<?php echo base_url() ?>public/js/pages/function/create_rto.js?t=<?php echo time(); ?>"></script>
