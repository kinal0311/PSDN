                    ...
                    <div class="card">
                        ...
                        <div class="body">
							...
							<!--div class="form-group form-float">
					            ...
					            <div class="form-group form-float">
                                	<div class="form-line">
                                         <select class="form-control show-tick" name="veh_cat"  id="veh_cat" data-live-search="true" required >
                            ...
                            ?>
                             <div class="row clearfix">
                                ...
                                <label class="form-label">Selling Price</label><br />
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" name="selling_price" step="1"  id="selling_price" placeholder="Selling Price" value="<?php echo isset($userinfo['selling_price'])?$userinfo['selling_price']:""; ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
							  ...
							  <div class="form-line">
								<label class="form-label">Vehicle Owner ID Proof </label><br />
									...
									<?php if(isset($userinfo['vehicle_owner_id_proof']) &&  strlen($userinfo['vehicle_owner_id_proof'])>0) { ?>
										<div class="pull-left" style="color:#1F91F3"><p></p><a href="<?php echo base_url().$userinfo['vehicle_owner_id_proof']; ?>" target="_blank" download>Download</a></div>
							  ...
							  <div class="form-line">
								<label class="form-label">Vehicle Owner Photo </label><br />
									...
									<?php if(isset($userinfo['vehicle_owner_photo']) &&  strlen($userinfo['vehicle_owner_photo'])>0) { ?>
										<div class="pull-left" style="color:#1F91F3"><p></p><a href="<?php echo base_url().$userinfo['vehicle_owner_photo']; ?>" target="_blank" download>Download</a></div>
							  ...
							  <div class="form-line">
								<label class="form-label">RC Book Photo </label><br />
									...
									<?php if(isset($userinfo['rc_book_photo']) &&  strlen($userinfo['rc_book_photo'])>0) { ?>
										<div class="pull-left" style="color:#1F91F3"><p></p><a href="<?php echo base_url().$userinfo['rc_book_photo']; ?>" target="_blank" download>Download</a></div>
							  ...
							  <div class="form-line">
								<label class="form-label">Device Photo </label><br />
									...
									<?php if(isset($userinfo['veh_speed_governer_photo']) &&  strlen($userinfo['veh_speed_governer_photo'])>0) { ?>
										<div class="pull-left" style="color:#1F91F3"><p></p><a href="<?php echo base_url().$userinfo['veh_speed_governer_photo']; ?>" target="_blank" download>Download</a></div>
									<?php } ?>
							...
							<div class="form-group form-float">
							  <div class="form-line">
							   <label class="form-label">Vehicle Photo </label><br />
									...
									<div class="pull-left" style="color:#1F91F3"><p></p><a href="<?php echo base_url().$userinfo['veh_photo']; ?>" target="_blank" download>Download</a></div>
