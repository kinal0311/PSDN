                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-float">
                                 ...
                                 <div class="row clearfix">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" tabindex="2" class="form-control" id="p_tac_no[]" name="p_tac_no[]" required>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" tabindex="3" class="form-control" id="p_tac_no[]" name="p_tac_no[]">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" tabindex="4" class="form-control" id="p_tac_no[]" name="p_tac_no[]">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" tabindex="5" class="form-control" id="p_tac_no[]" name="p_tac_no[]">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" tabindex="1" id="p_product_name" name="p_product_name" >
