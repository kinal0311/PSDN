...
<?php } ?>                                                 
					...
					<!--- Search---->
							...
							<!--						<div class="form-line">-->
							<!--							<input type="text" class="form-control" placeholder="Search By RTO, Place, State." id="search" value="<?php echo isset($_GET['search'])?$_GET['search']:""; ?>" name="search">-->
							<!--						</div>-->
							<!--					</div>-->
							<!--				</div>									-->
                                             ...
                                             <div class="form-group">
                                                 <div class="form-line">
                                                     <input type="text" class="form-control"
                                                         placeholder="Search By RTO, Place" id="search"
                                             ...
                                             <div class="form-group form-float">
                                                 <div class="form-line">
                                                     <select class="form-control show-tick" name="state_id"
                                                         id="state_id" data-live-search="true">
                                        ...
                                        <div class="col-sm-4">
                                             <div class="form-group">
                                                 ...
                                                 <button class="btn btn-primary waves-effect" type="submit"
                                                     id="searchfiltersubmit" name="searchfiltersubmit">Search</button>
                                                 <!-- </div> -->
                                        </div>
                                    </div>
                                </div>
...
<?php } ?>					   	  
				...
				if(count($listofRTONumbers)>0)
				{
						...
						{			
							$enc_rto_num = base64_encode($value['rto_no']);				
						?>
						<tr>
						<td><?php echo $sno; ?></td>
						...
						<td style="text-align: center;" class="text-left">
							 ...
							 <a class='btn btn-info btn-xs' href="<?php echo base_url()."admin/edit_rto_number/?q=".$enc_rto_num; ?>">
								<span class="glyphicon glyphicon-edit"></span> Edit
							 </a>							
							<?php } ?>
						
                            <?php if (check_permission($user_type, 'cerificate_interchange')) { ?>
								<a class='btn btn-danger btn-xs' onClick="showConfirmmesage(<?php echo $value['rto_no']?>)">
									<span class="glyphicon glyphicon-trash" title="Delete Rto"></span>
								</a>
								<?php } ?>
							</td>
                         <?php } ?>				
	...
	<script src="<?php echo base_url() ?>public/js/pages/function/rto_list_data.js"></script>
	...
	<script>	
		$(function() {
				...
				if ('<?php echo intval($totalNoOfRTO); ?>' < 25) {
