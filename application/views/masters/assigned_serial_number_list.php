        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<!--- Search---->
								<form action="<?php echo base_url() ?>admin/assigned_serial_number_list" name="searchfilter"  id="searchfilter" method="get" />				
										<input type="hidden" name="offset"   id="offset" value="<?php echo isset($_GET['offset'])?$_GET['offset']:0; ?>">				
										<div class="row clearfix">
											<div class="col-sm-3">
												<div class="form-group">
													<div class="form-line">
														<input type="text" class="form-control" placeholder="Search by Serial No, IMEI" id="search" value="<?php echo isset($_GET['search'])?$_GET['search']:""; ?>" name="search">
													</div>
												</div>
											</div>									
											<!-- <div class="col-sm-2">
                                            ...
                                            <div class="form-line">
                                                <select class="form-control show-tick" name="s_product_id"
                                                    ...
                                                    <option <?php /* echo $selected; */ ?>
                                                        ...
                                                        <?php /* echo $value['p_product_name']  */?></option>
                                                    <?php
				                                            /* } */
				                                            ?>
                                                </select>
...
/*															$used='';
												...
												<div class="form-group form-float">
													<div class="form-line">
														<select class="form-control show-tick" name="used_status" id="used_status" data-live-search="true">
															...
															?>
															<option <?php echo $used;?> value="1">Used</option>
															<option <?php echo $unused;?> value="2">Unused</option>
														</select>
													 </div>
												</div>
											</div>
                                        ...
                                        <div class="col-sm-2">
											...
											<div class="col-sm-1">
												<div class="form-group">
													<div class="form-line">
														<a class="btn btn-primary waves-effect" href= "<?php echo base_url() ?>admin/assigned_serial_number_list">Clear</a>
													</div>
												</div>
											</div>
											<div class="col-sm-2">
										...
										<div class="row">
										<div class="col-sm-4">
        										<p style="padding-top: 5px;"><b>Company : </b>PSDN Technology Pvt Ltd</p>
        									</div>
										</div>
							</form>
  ...
  <input type="checkbox" class="chk-ind" id="chk<?php echo $sno; ?>" name="serial_ids[]" value="<?php echo $value['s_serial_id']; ?>" > <label for="chk<?php echo $sno; ?>"></label>
								...
								<td><?php echo ((string)$value['s_used']==='1')?'Used':'Unused'; ?></td>
								<?php if(check_permission($user_type,"cerificate_interchange")){ ?>
                                    <td class="text-left">
                                        <a class='btn btn-info btn-xs' href="<?php echo base_url()."admin/check_device_status?imei=".base64_encode($value['s_imei']); ?>">
                                        <span class="glyphicon glyphicon-info-sign" title="Device Info"></span></a>
                                    </td>
                                <?php } ?>
								<!-- <td class="text-left">
