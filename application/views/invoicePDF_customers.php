...
<!-- info row 1 starts-->
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            ...
            <strong><?php echo $userinfo['user_name']; ?></strong><br>
        ...
        <div class="col-sm-4 invoice-col"><b class="inv-sub-title">INVOICE TO</b>
        
        <!-- <address>
            <strong><?php //echo $userinfo['c_customer_name']; ?></strong><br>
			<?php //echo $userinfo['c_customer_name']; ?><br>
            <?php //echo nl2br($userinfo['c_address']); ?><br>

            Phone: <?php //echo $userinfo['c_phone']; ?><br>
            Email: <?php //echo $userinfo['c_email']; ?>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <b>Acc Number:</b> <?php echo $userinfo['acc_no'];?>,<br> <b>Acc Name:</b> <?php echo $userinfo['acc_name'];?>,<br> <b>IFSC:</b> <?php echo $userinfo['acc_ifsc_code'];?> <br>
          <b>Branch</b>: <?php echo $userinfo['acc_branch'];?>.
...
<script type="text/javascript">
    ...
    function PrintDiv1() {
        ...
        printWindow.document.write('<html><head> <style>tr td { font-size:14px;color:black;padding-left:10px;  }</style><title>Department Copy</title><link href="../public/pdf/bootstrap.min.css" rel="stylesheet" />');
