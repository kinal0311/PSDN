...
<div class="row" style="margin-top:10px;">
    ...
    <table class="tab_header" width="100%" cellpadding="0" cellspacing="0">
    <tr>
   <td> <img  src="<?php echo base_url().$userinfo['veh_photo']; ?>" class="img-responsive"> </td>
    <td> <img  src="<?php echo base_url().$userinfo['vehicle_owner_id_proof']; ?>" class="img-responsive"> </td>
    <td> <img  src="<?php echo base_url().$userinfo['vehicle_owner_photo']; ?>" class="img-responsive"> </td>
    <td> <img  src="<?php echo base_url().$userinfo['rc_book_photo']; ?>" class="img-responsive"> </td>
    </tr>
    </table>
    </div>
