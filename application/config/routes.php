...
//$route['portal/tracking_vehicle'] = 'admin/tracking_vehicle';
$route['portal/all_customer_vehicles'] = 'admin/all_customer_vehicles';


$route['portal/cerificate_list'] = 'Mobileapi102/cerificate_list';
$route['portal/remove_expired_list'] = 'dashboard/remove_expired_list';

$route['portal/tracking'] = 'admin/tracking';

$route['portal/view_tracking'] = 'Mobileapi102/view_tracking';
$route['portal/search_vehicle'] = 'admin/search_vehicle';

$route['portal/distributor_customer'] = 'admin/distributor_customer';
$route['portal/dealer_customer'] = 'admin/dealer_customer';
//$route['admin/search_device_status'] = 'admin/search_device_status';

//$route['portal/exp_date_message'] = 'admin/exp_date_message';
$route['portal/exp_date_message'] = 'Mobileapi102/certificate_exp_date_message';
